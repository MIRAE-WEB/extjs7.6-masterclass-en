 ...
 *
 */
Ext.define('Miraeweb.window.file.dropzone.FileDropZone', {
    extend: 'Ext.container.Container',
    alias: ['widget.file-dropzone'],
    requires: [
    ...
    afterRender: function(){
        ...
        var text =[
            '<div class="miraeweb-filedrop-zone">',
                '<div class="miraeweb-filedrop-text">Drop File Here</div>',
            '</div>'
            ];
        var html = text.join('');
        me.setHtml(html);
